...
class TicketConstants {
  static final List<ScratchTicket> allTickets = [
    ...
    ScratchTicket(
      ...
      category: 'BSC',
      prizes: [
        Prize(emoji: '🏆', text: 'GRATE SEZON!\n5,000 GOUD', value: 5000, weight: 3),
    ...
    ScratchTicket(
      ...
      category: 'PRM',
      prizes: [
        Prize(emoji: '🏆', text: 'MEGA CHANS!\n15,000 GOUD', value: 15000, weight: 3),
    ...
    ScratchTicket(
      ...
      category: 'BRZ',
      prizes: [
        Prize(emoji: '🏆', text: 'GRATE SEZON!\n50,000 GOUD', value: 50000, weight: 3),
    ...
    ScratchTicket(
      ...
      category: 'SLV',
      prizes: [
        Prize(emoji: '🏆', text: 'MEGA AJAN!\n150,000 GOUD', value: 150000, weight: 3),
    ...
    ScratchTicket(
      ...
      category: 'DMD',
      prizes: [
        Prize(emoji: '🏆', text: 'MEGA AJAN!\n1,000,000 GOUD', value: 1000000, weight: 3),
