...
class TicketConstants {
  static final List<ScratchTicket> allTickets = [
    ...
    ScratchTicket(
      ...
      category: 'BAS',
      prizes: [
        Prize(emoji: '🏆', text: 'GRATE SEZON!\n5,000 GOUD', value: 5000, weight: 30),
        Prize(emoji: '✨', text: 'OU GENYEN\n1,000 GOUD', value: 1000, weight: 70),
        Prize(emoji: '🎲', text: 'OU GENYEN\n100 GOUD', value: 100, weight: 100),
        Prize(emoji: '😅', text: 'ESEYE ANKÒ', value: 0, weight: 800),
      ],
      theme: TicketTheme(
        gradientColors: [
          Color(0xFF10b981),
    ...
    ScratchTicket(
      ...
      category: 'BRZ',
      prizes: [
        Prize(emoji: '🏆', text: 'GRATE SEZON!\n50,000 GOUD', value: 50000, weight: 10),
        Prize(emoji: '💎', text: 'OU GENYEN\n25,000 GOUD', value: 25000, weight: 30),
        Prize(emoji: '✨', text: 'OU GENYEN\n10,000 GOUD', value: 10000, weight: 70),
        Prize(emoji: '🎲', text: 'OU GENYEN\n1,000 GOUD', value: 1000, weight: 90),
        Prize(emoji: '😅', text: 'ESEYE ANKÒ', value: 0, weight: 800),
      ],
      theme: TicketTheme(
        gradientColors: [
    ...
    ScratchTicket(
      ...
      prizes: [
        ...
        Prize(emoji: '💎', text: 'OU GENYEN\n75,000 GOUD', value: 75000, weight: 10),
        Prize(emoji: '🌟', text: 'OU GENYEN\n25,000 GOUD', value: 25000, weight: 15),
        Prize(emoji: '🎰', text: 'OU GENYEN\n10,000 GOUD', value: 10000, weight: 25),
        Prize(emoji: '💰', text: 'OU GENYEN\n5,000 GOUD', value: 5000, weight: 35),
        Prize(emoji: '💵', text: 'OU GENYEN\n2,500 GOUD', value: 2500, weight: 40),
        Prize(emoji: '✨', text: 'OU GENYEN\n1,000 GOUD', value: 1000, weight: 40),
        Prize(emoji: '🎲', text: 'OU GENYEN\n250 GOUD', value: 250, weight: 30),
        Prize(emoji: '😅', text: 'ESEYE ANKÒ', value: 0, weight: 800),
      ],
      theme: TicketTheme(
        gradientColors: [
    ...
    ScratchTicket(
      ...
      prizes: [
        ...
        Prize(emoji: '🌟', text: 'OU GENYEN\n50,000 GOUD', value: 50000, weight: 12),
        Prize(emoji: '🎰', text: 'OU GENYEN\n25,000 GOUD', value: 25000, weight: 20),
        Prize(emoji: '💰', text: 'OU GENYEN\n10,000 GOUD', value: 10000, weight: 30),
        Prize(emoji: '💵', text: 'OU GENYEN\n5,000 GOUD', value: 5000, weight: 40),
        Prize(emoji: '✨', text: 'OU GENYEN\n2,500 GOUD', value: 2500, weight: 45),
        Prize(emoji: '🎲', text: 'OU GENYEN\n500 GOUD', value: 500, weight: 40),
        Prize(emoji: '😅', text: 'ESEYE ANKÒ', value: 0, weight: 800),
      ],
      theme: TicketTheme(
        gradientColors: [
    ...
    ScratchTicket(
      ...
      category: 'DIA',
      prizes: [
        Prize(emoji: '🏆', text: 'MEGA AJAN!\n1,000,000 GOUD', value: 1000000, weight: 2),
        Prize(emoji: '💎', text: 'OU GENYEN\n500,000 GOUD', value: 500000, weight: 5),
        Prize(emoji: '🌟', text: 'OU GENYEN\n250,000 GOUD', value: 250000, weight: 10),
        Prize(emoji: '🎰', text: 'OU GENYEN\n100,000 GOUD', value: 100000, weight: 15),
        Prize(emoji: '💰', text: 'OU GENYEN\n50,000 GOUD', value: 50000, weight: 25),
        Prize(emoji: '💵', text: 'OU GENYEN\n10,000 GOUD', value: 10000, weight: 40),
        Prize(emoji: '✨', text: 'OU GENYEN\n5,000 GOUD', value: 5000, weight: 50),
        Prize(emoji: '🎲', text: 'OU GENYEN\n1,000 GOUD', value: 1000, weight: 53),
        Prize(emoji: '😅', text: 'ESEYE ANKÒ', value: 0, weight: 800),
      ],
      theme: TicketTheme(
        gradientColors: [
