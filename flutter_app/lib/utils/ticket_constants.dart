...
class TicketConstants {
  static final List<ScratchTicket> allTickets = [
    ...
    ScratchTicket(
      ...
      category: 'BAS',
      prizes: [
        Prize(emoji: '🎉', text: 'OU GENYEN\n5,000 GOUD', value: 5000, weight: 39),
        Prize(emoji: '💎', text: 'OU GENYEN\n2,500 GOUD', value: 2500, weight: 117),
        Prize(emoji: '🔥', text: 'OU GENYEN\n1,000 GOUD', value: 1000, weight: 391),
        Prize(emoji: '💰', text: 'OU GENYEN\n500 GOUD', value: 500, weight: 978),
        Prize(emoji: '🎁', text: 'OU GENYEN\n100 GOUD', value: 100, weight: 2348),
        Prize(emoji: '✨', text: 'OU GENYEN\n5 GOUD', value: 5, weight: 3914),
        Prize(emoji: '🏆', text: 'OU GENYEN\n500 HTG', value: 500, weight: 39),
        // New HTG cash prizes (0.5% each)
        Prize(emoji: '💵', text: 'OU GENYEN\n450 HTG', value: 450, weight: 100),
        Prize(emoji: '💵', text: 'OU GENYEN\n400 HTG', value: 400, weight: 100),
        Prize(emoji: '💵', text: 'OU GENYEN\n350 HTG', value: 350, weight: 100),
        Prize(emoji: '💵', text: 'OU GENYEN\n300 HTG', value: 300, weight: 100),
        Prize(emoji: '💵', text: 'OU GENYEN\n250 HTG', value: 250, weight: 100),
        Prize(emoji: '💵', text: 'OU GENYEN\n200 HTG', value: 200, weight: 100),
        Prize(emoji: '💵', text: 'OU GENYEN\n150 HTG', value: 150, weight: 100),
        Prize(emoji: '💵', text: 'OU GENYEN\n100 HTG', value: 100, weight: 100),
        Prize(emoji: '💸', text: 'OU GENYEN\n1,000 HTG', value: 1000, weight: 1),
        // Ticket prizes
        Prize(emoji: '🥉', text: 'OU GENYEN\nYON TIKÈ BRONZE', value: 250, weight: 1600),
        Prize(emoji: '⭐', text: 'OU GENYEN\nYON TIKÈ PREMIUM', value: 100, weight: 1600),
        Prize(emoji: '🥈', text: 'OU GENYEN\nYON TIKÈ SILVER', value: 500, weight: 200),
        Prize(emoji: '🥇', text: 'OU GENYEN\nYON TIKÈ GOLD', value: 1000, weight: 100),
        Prize(emoji: '💎', text: 'OU GENYEN\nYON TIKÈ DIAMOND', value: 5000, weight: 1),
        Prize(emoji: '😅', text: 'ESEYE ANKÒ', value: 0, weight: 7868),
      ],
      theme: TicketTheme(
        gradientColors: [
          Color(0xFF10b981),
